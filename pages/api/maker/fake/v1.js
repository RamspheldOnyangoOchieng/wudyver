...
class HtmlToImg {
  ...
  async generate({
    ...
    ppUrl = "https://png.pngtree.com/thumb_back/fw800/background/20230117/pngtree-girl-with-red-eyes-in-anime-style-backdrop-poster-head-photo-image_49274352.jpg",
    model: template = 1,
    type = "v5"
  }) {
    const templateSizes = {
